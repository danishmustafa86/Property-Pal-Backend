"""FastAPI application for property search, listings, and chat-assisted discovery."""
...
from app.routes import agents, chat, health, map_properties, places, properties, search, uploads, users
